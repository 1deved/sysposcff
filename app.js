...
const SCRIPT_URL =
  "https://script.google.com/macros/s/AKfycbyLr41QNUskano1G8mXVHBZKcGpaFXKP2t1oCUys-fZGNt69FFZR4un0A1LI0LYddgnhw/exec";
...
function getOrderRequestId(orderData) {
  const storageKey = "sysposcff-pending-order";
...
async function processOrder() {
  ...
  try {
    ...
    if (result && result.success) {
      localStorage.removeItem("sysposcff-pending-order");
