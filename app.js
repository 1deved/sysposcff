...
const SCRIPT_URL =
  "https://script.google.com/macros/s/AKfycbxTaUtx2os0cgtr2F7VLhP8YImOw3Cw_9vWULmCNIyxf_3M7AO2IBxZB_cMA-eUnf5lEw/exec";
const INITIAL_DATA_CACHE_KEY = "sysposcff-initial-data-v1";
const INITIAL_DATA_CACHE_TTL_MS = 5 * 60 * 1000;
const DASHBOARD_CACHE_KEY = "sysposcff-dashboard-v1";
